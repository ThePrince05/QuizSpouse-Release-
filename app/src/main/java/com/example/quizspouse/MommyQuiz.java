...
public class MommyQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        globalVariables.setUserName("Mommy");
        ...
        aanswer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(currentQuestions < questionsItems.size() - 1){
                    ...
                    Intent intent = new Intent(MommyQuiz.this, ResultActivity.class);
    ...
    private void loadAllQuestions() {
        ...
        String query = "SELECT question, answer1, answer2, answer3, answer4, correct FROM Questions Where username = 'Mommy' ";
    ...
    public void onBackPressed() {
        MaterialAlertDialogBuilder MaterialAlertDialogBuilder = new MaterialAlertDialogBuilder(MommyQuiz.this);
        ...
        MaterialAlertDialogBuilder.setPositiveButton(R.string.yes, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent( MommyQuiz.this, MainActivity.class));
                finish();
            }
        });
